...
class Aquarium(object):
    ...
    def __init__(self,lightStartTime = LIGHT_START_TIME,lightOnTime = LIGHT_ON_TIME):
        ...
        f.close()
        self.lightThread = threading.Thread(target=self.autoController)
    ...
    def tryFeed(self):
        ...
        else: feedLapse = currentTime - self._lastFeed
        if feedLapse >= REQUIRED_FEED_LAPSE:
            ...
            return 'Fishes feeded ' + str(feedLapse) +' hours ago'
    ...
    def _food(self):
        try:
            ...
            return 'Error feeding, please leave a post'

    def autoController(self):
        while self._aquariumOn:    
            try:
                ...
                else: feedLapse = currentHour - self._lastFeed
