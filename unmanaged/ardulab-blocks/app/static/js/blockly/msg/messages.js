...
Blockly.Msg.ZUM_BUT = 'Button';
Blockly.Msg.ZUM_AS = 'as';
Blockly.Msg.ZUM_BUT_TIP = 'Block for initializating buttons';
Blockly.Msg.ZUM_BUT_HELP = 'https://github.com/pololu/pushbutton-arduino';
Blockly.Msg.ZUM_BUT_ISPRESSED = 'is pressed';
Blockly.Msg.ZUM_BUT_ISPRESSED_TIP = 'Check if a button is pressed';
Blockly.Msg.ZUM_BUT_ISPRESSED_HELP = 'https://github.com/pololu/pushbutton-arduino';
Blockly.Msg.ZUM_BUT_INIT_WARN = 'Buttons must be initializated';
Blockly.Msg.ZUM_BUT_UNKNOWN_WARN = 'Unknown warning';
Blockly.Msg.ZUM_BUT_BADCON_WARN = 'Not valid block configuration';
Blockly.Msg.ZUM_BUT_WAITFOR = 'Wait for';
Blockly.Msg.ZUM_BUT_WAITFOR_TIP = 'Check if a button is pressed';
Blockly.Msg.ZUM_BUT_WAITFOR_HELP = 'https://github.com/pololu/pushbutton-arduino';
Blockly.Msg.ZUM_BUT_PRES = 'single press';
Blockly.Msg.ZUM_BUT_PRES_TIP = 'Check if button has been signle pressed';
Blockly.Msg.ZUM_BUT_PRES_HELP = 'https://github.com/pololu/pushbutton-arduino';
Blockly.Msg.ZUM_MOT_SET_LS = 'Set left motor speed to';
Blockly.Msg.ZUM_MOT_SET_LS_TIP = 'Change left motor speed. Input range is -400 to 400';
Blockly.Msg.ZUM_MOT_SET_LS_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/class_zumo32_u4_motors.html';
Blockly.Msg.ZUM_MOT_SET_RS = 'Set right motor speed to';
Blockly.Msg.ZUM_MOT_SET_RS_TIP = 'Change right motor speed. Input range is -400 to 400';
Blockly.Msg.ZUM_MOT_SET_RS_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/class_zumo32_u4_motors.html';
Blockly.Msg.ZUM_MOT_SET_2S = 'Change two motors speed';
Blockly.Msg.ZUM_RIGHT_M = 'Right';
Blockly.Msg.ZUM_LEFT_M = 'Left';
Blockly.Msg.ZUM_MOT_SET_2S_TIP = 'Set left motor speed. Input range is -400 to 400';
Blockly.Msg.ZUM_MOT_SET_2S_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/class_zumo32_u4_motors.html';
Blockly.Msg.ZUM_PROX_READ = 'Read proximity sensors';
Blockly.Msg.ZUM_PROX_READ_TIP = 'Read proximity sensors, for retrieving sensor values calling this function first is necesary';
Blockly.Msg.ZUM_PROX_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/class_zumo32_u4_proximity_sensors.html#details';
Blockly.Msg.ZUM_PROX_GET = 'detect on his';
Blockly.Msg.ZUM_PROX_GET_TIP = 'Return proximity sensor values, Call "Read proximity sensors" first for getting correct values';
Blockly.Msg.ZUM_SENSOR_1 = ' ';
Blockly.Msg.ZUM_SENSOR_2 = 'sensor';
Blockly.Msg.ZUM_LINE_READ = 'Read line sensors';
Blockly.Msg.ZUM_LINE_READ_TIP = 'Read line sensors, for retrieving sensor values calling this function first is necesary';
Blockly.Msg.ZUM_LINE_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/class_zumo32_u4_line_sensors.html';
Blockly.Msg.ZUM_LINE_GET_1 = ' ';
Blockly.Msg.ZUM_LINE_GET_2 = 'line-sensor value';
Blockly.Msg.ZUM_LINE_GET_TIP = 'Return line sensor values, Call "Read line sensors" first for getting correct values';
Blockly.Msg.ZUM_RIGHT = 'right';
Blockly.Msg.ZUM_LEFT = 'left';
Blockly.Msg.ZUM_CENTER = 'center';
Blockly.Msg.ZUM_CENTERLEFT = 'center-left';
Blockly.Msg.ZUM_CENTERRIGHT = 'center-right';
Blockly.Msg.ZUM_LEDS_TIP = 'Change the status of one of the two leds located on the robot';
Blockly.Msg.ZUM_LEDS_HELP = 'http://pololu.github.io/zumo-32u4-arduino-library/_zumo32_u4_8h.html#ae6ec5117b26ffaaa1b81c8c8b34426e1';
Blockly.Msg.ZUM_LEDS_BLUE = 'blue';
Blockly.Msg.ZUM_LEDS_RED = 'red';
Blockly.Msg.ZUM_LEDS_SET = 'Set';
Blockly.Msg.ZUM_LEDS_TO = 'led to';
